<template>
  <div class="container relatorios">
    <h1 class="titulo-pagina">Relatório de vendas</h1>
    ...
    <div v-if="relatorio?.porFormaPagamento?.length" class="card">
      <p class="subtitulo">Por forma de pagamento</p>
    ...
    <div v-if="relatorio" class="card">
      ...
      <div class="tabela-wrap">
        ...
        <tbody>
          ...
          <tr v-if="!relatorio.porDia.length"><td colspan="3" class="vazio">Nenhuma venda no período.</td></tr>
        </tbody>
      </table>
        </div>
    </div>
    ...
    <div v-if="relatorio" class="card">
      <p class="subtitulo">Produtos mais vendidos</p>
      <div class="tabela-wrap">
        <table>
        ...
        <tbody>
          ...
          <tr v-if="!relatorio.porProduto.length"><td colspan="3" class="vazio">Nenhuma venda no período.</td></tr>
        </tbody>
      </table>
        </div>
    </div>
...
.resumo-cards { display: grid; grid-template-columns: repeat(auto-fit, minmax(160px, 1fr)); gap: 12px; }
.stat-card {
